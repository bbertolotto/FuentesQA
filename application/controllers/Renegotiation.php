...
/** Begin::CC028:: **/ 
            ...
            $value["diasMora"] = $result["diasMora"];
/** End::CC028:: **/ 
...
/** Begin::CC028:: **/ 
    ...
    if($result["retorno"]!=0){ cancel_function(10, "<strong>No fue posible validar si " . $dataHomologador["name_product"] . ", registra alg&uacute;n bloqueo.</br>Impide curse ". NAME__PRODUCT_REN . "<strong>", ""); }
    if($result["allow_sale"]!=""){ cancel_function(10, "<strong>Estado " . $dataHomologador["name_product"] . ", Impide curse ". NAME__PRODUCT_REN . "<strong></br>" . $result["allow_sale"], ""); }
...
/** End::CC028:: **/ 
    ...
    if((float)$dataParameters->min_payment_porcentage_value<=0){

        $descRetorno = "Valor parámetro, porcentaje monto pago mínimo no es valido..!";
        cancel_function(COD_ERROR_INIT, $descRetorno, "");
    }

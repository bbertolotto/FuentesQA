                    ...
                    <div class="sidebar-content">
                        ...
                        <ul class="sidebar-nav">
                            ...
                            <li <?php if(substr($this->session->userdata('selector'),0,1)=='3'){echo 'class="active"';}?>>
                                ...
                                <ul>
                                    <li>
                                        <a href="/client/search" <?php if($this->session->userdata('selector')=='3.0.1'){echo 'class="active"';}?> onclick="p = document.getElementById('processing'); p.style.display='';"><i class="fa fa-search sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide"><?= $this->lang->line('Search');?></span></a>
                                    </li>
...
<input type="text" id="aa" value="<?=$this->session->userdata("id_office")?>">

<?php if($this->session->userdata("id_office")!="01000" AND $this->session->userdata("id_office")!="01010" AND $this->session->userdata("id_office")!="01020"):?>
                                  <li>
            ...
            <ul>
                ...
                <li <?php if(substr($this->session->userdata('selector'),0,5)=='5.1.2'){echo 'class="active"';}?>>
                    ...
                    <ul>
                        ...
                        <li><!--vi__feriados-->
                          <a href="/parameters/holidays" <?php if($this->session->userdata('selector')=='5.1.2.1'){echo 'class="active"';}?> onclick="p = document.getElementById('processing'); p.style.display='';"><i class="gi gi-beach_umbrella sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Feriados</span></a>
                        </li>

                        <li><!--vi__motivo_rechazo-->
                          <a href="/parameters/rejection" <?php if($this->session->userdata('selector')=='5.1.2.2'){echo 'class="active"';}?> onclick="p = document.getElementById('processing'); p.style.display='';"><i class="gi gi-ban sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Motivos Rechazo</span></a>
                        </li>
            ...
            <ul>
                <li><!--ta_users-->
                 ...
                 <li><!--ta_journal_log_event-->
                  <a href="/users/eventlog" <?php if($this->session->userdata('selector')=='5.2.1.3'){echo 'class="active"';}?> onclick="p = document.getElementById('processing'); p.style.display='';"><i class="gi gi-wrench sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide"><?= $this->lang->line('Event Log');?></span></a>
                </li>

<?php
/**
 * Author: Patricio Cruz Vega
 * Email: patricio.cruz@teknodata.cl
 * Date: 22-10-19
 */
/**
 * Class Rut
...
{
    /**
     * Caracteres que debemos eliminar del rut para validar
     * @var array
     */
    protected $escapeChars = [".", ",", "-", "_", " "];
    /**
     * Caracteres validos del rut para validar
     * @var string
     */
    protected $regex = '/([^0-9kK])/';
    /**
     * Caracter separacion del rut para validar
     * @var string
     */
    protected $vnSeparator  = "-";
    /**
     * Mínimo de caracteres del RUT para validar
     * @var int
     */
    protected $minChars = 5;
    /**
     * Máximo de caracteres del RUT para validar
     * @var int
     */
    protected $maxChars = 10;
    /**
     * Determina si la clase arroja exceptions en validacion de errores
     * @var bool
     */
    protected $useExceptions = true;
    /**
     * Número del RUT. Ejemplo 12.479.692-K ($rut = 12479692)
     * @var integer
     */
    protected $number = null;
    /**
     * Número del RUT. Ejemplo 12.479.692-K ($vn = 12479692)
     * @var string
     */
    protected $vn = null;
    /**
     ...
     * @param $rut
     * @param null $vn
     * @throws InvalidArgumentException extend LogicException
     *
     * @return bool
     */
    public function hasValidFormat()
    {
        ...
        if (!$is_ok && $this->useExceptions) {
            throw new InvalidArgumentException("R.U.T. '{$this->number}' with verification code '{$this->vn}' has an invalid format");
        }
        return $is_ok;
    }
    /**

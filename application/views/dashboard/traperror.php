...
<!--
      <div class="col-xs-12 col-sm-6 col-lg-4">
          <a href="<?= base_url();?>refinance/search" class="widget widget-hover-effect1 font-bottom">
              <div class="widget-simple">
                  <div class="widget-icon pull-left themed-background-fire animation-fadeIn">
                      <i class="fa fa-refresh"></i>
                  </div>
                  <h3 class="widget-content text-center animation-pullDown">
                      <strong>Refinanciamiento</strong><br>
                      <small>Negociar Ofertas Disponibles</small>
                  </h3>
              </div>
          </a>
      </div-->
...
<input type="hidden" id="warning_message" value="<?=$this->session->flashdata('warning_message')?>">
...
$("#body-modal-access").html("Ocurrio un error, "+$("#warning_message").val());

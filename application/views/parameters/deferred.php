                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group col-sm-4">
                                    ...
                                    <select name="name_item" class="form-control" id="name_item">
                                            <option value="">Seleccione descripcion</option>
                                            <?php foreach ($deferred as $deferreds):?>
                                                <option value="<?= $deferreds->NAME ?>"><?= $deferreds->NAME ?></option>
                                            <?php endforeach; ?>    
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group col-sm-4">
                                    ...
                                    <select name="name_iteme" class="form-control" id="name_iteme">
                                            <option value="">Seleccione descripcion</option>
                                            <?php foreach ($deferred as $deferreds):?>
                                                <option value="<?= $deferreds->NAME ?>"><?= $deferreds->NAME ?></option>
                                            <?php endforeach; ?>    
...
$('.table tbody').on('click', '.deletes', function () {   
    ...
    if (result.value) {
        ...
        var idfound =  $tr.find("td:eq(3)").find(".deletes").attr("data-id");
        console.log(idfound);
        $.ajax({    

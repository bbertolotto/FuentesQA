...
<page>
    <table style="width: 100%;">
        <tr style="width: 100%; ">
            <td style="width: 100%; text-align: left;"><img src="img/logo_spin_visa.jpg" width="200" height="50" border="0"/></td>
        </tr>
    </table>
    <br><br><br><br>
    <table style="width: 100%;">
        ...
        <tr style="width: 100%; ">
            <td style="width: 100%; font-size: 12px; text-align: justify;">COMPROBANTE DE ENTREGA TARJETA SPIN VISA, HE RECIBIDO POR PARTE DE CRUZ VERDE LA TARJETA DE CREDITO SPIN VISA DETALLADA A CONTINUACION<br><br><br>

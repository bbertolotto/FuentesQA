...
<div id="page-content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="#" method="post" class="form-bordered" onsubmit="return false;">
                ...
                <div class="form-group col-xs-6 col-sm-4 col-lg-2">
                    ...
                    <input type="text" id="rutClient" name="rutClient" maxlength="12" class="form-control text-center" placeholder="" onkeypress="return Teknodata.enter_onlyRut(event);" onkeyup="Teknodata.masked_nroRut(this)" data-target="" data-toggle="tooltip" data-placement="top" title="Digite Número Rut y Presione Enter para buscar .."></input>
                </div>
                <div class="form-group col-xs-6 col-sm-4 col-lg-2">
                    <label for="example-nf-name">Nombres</label>
                    <input type="text" id="nameClient" name="nameClient" class="form-control text-center" onKeyUp="this.value=this.value.toUpperCase();" readonly >

                </div>
                <div class="form-group col-xs-6 col-sm-4 col-lg-2">
                    <label for="example-nf-lastnameFather">Apellido Paterno</label>
                      <input type="text" id="lastFatherClient" name="lastFatherClient" class="form-control text-center" onKeyUp="this.value=this.value.toUpperCase();" readonly >
                </div>
                <div class="form-group col-xs-6 col-sm-4 col-lg-2">
                    <label for="example-nf-lastnameMother">Apellido Materno</label>
                      <input type="text" id="lastMotherClient" name="lastMotherClient" class="form-control text-center" onKeyUp="this.value=this.value.toUpperCase();" readonly >
                </div>
                ...
                <div class="form-group col-xs-6 col-sm-4 col-lg-2">
                    ...
                    <div class="input-group">
                        <input type="text" id="birthDateClient" name="birthDateClient" class="form-control input-datepicker text-center" data-date-format="dd-mm-yyyy" >
                ...
                <div class="form-group col-xs-6 col-sm-4 col-lg-1">
                    ...
                    <input type="text" id="typeClient" name="typeClient" class="form-control text-center" readonly >
                </div>

                <div class="form-group col-xs-6 col-sm-4 col-lg-1">
                    <label for="scoreClient">Score</label>
                    <input type="text" id="scoreClient" name="scoreClient" class="form-control text-center" readonly >
                </div>
                ...
                <div class="form-group col-xs-6 col-sm-4 col-lg-2">
                    <label for="countryResidence">Pais de Residencia</label>
                        ...
                        <select id="countryResidence" class="form-control text-center" >
                            <?php
                                echo '<option value=""></option>';
                                foreach ($countries as $nodo) {
                                    echo '<option value="'.$nodo->KEY.'">'.$nodo->NAME.'</option>';
        ...
        <div class="row">
            ...
            <div class="block">
                <div class="block-title">
                    <h2><strong>Direcci&oacute;n</strong></h2>
                </div>


                <table class="table table-striped table-bordered">

                <form id="form-address" class="form-horizontal form-bordered" method="post">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                ...
                <form id="form-phones" class="form-bordered" method="post" >
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                ...
                <form id="form-card" class="form-bordered" method="post" >

                    <div class="form-group col-xs-6 col-sm-4 col-lg-2">
                        <label for="name_credit_card">Tipo Tarjeta </label>
                        <input type="text" id="name_credit_card" name="name_credit_card" class="form-control text-center" placeholder="Tipo Tarjeta" readonly >
                    </div>

                    <div class="form-group col-xs-6 col-sm-4 col-lg-2">
                        <label for="number_credit_card">N&#250;mero Tarjeta </label>
                        <input type="text" id="masked_credit_card" name="masked_credit_card" class="form-control text-center" placeholder="Número Tarjeta" readonly>
                    </div>

                    <div class="form-group col-xs-6 col-sm-4 col-lg-2">
                        <label for="amount_credit_card">Cupo Asignado </label>
                        <input type="text" id="amount_credit_card" name="amount_credit_card" class="form-control text-center" placeholder="Cupo Tarjeta" readonly>
                    </div>
...
<input type="hidden" id="campaign_number" name="campaign_number" value="">
<input type="hidden" id="payment_form_credit_card" name="payment_form_credit_card" value="03">
<input type="hidden" id="number_credit_card" name="number_credit_card" value="">
<input type="hidden" id="type_credit_card" name="type_credit_card" value="T">
<input type="hidden" id="descam" name="descam" value="">
<input type="hidden" id="tipcam" name="tipcam" value="">
...
<script src="/js/capturing/preapproved.js"></script>
</body>
</html>

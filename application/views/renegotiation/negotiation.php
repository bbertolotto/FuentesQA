    ...
    <fieldset>
        ...
        <div id="winpaynormal" >
          ...
          <div class="form-group col-xs-4 col-sm-4 col-lg-1">
              ...
              <select id="numberQuotesNormal" name="numbeQuotesNormal" class="form-control text-center" data-target="" onchange="javascript:$('.btn-simulate').click();">
                  <?php
        ...
        <div id="winpaydifer" style="display:none;">
          ...
          <div class="form-group col-xs-4 col-sm-4 col-lg-1">
              ...
              <select id="numberDeferred" name="numberDeferred" class="form-control text-center" data-target="" onchange="javascript:$('.btn-simulate').click();">
                  <?php
          ...
          <div class="form-group col-xs-4 col-sm-4 col-lg-1">
              ...
              <select id="numberQuotesDifer" name="numberQuotesDifer" class="form-control text-center" data-target="" onchange="javascript:$('.btn-simulate').click();">
                  <?php
                  for ($i = $environment["MINIMO_CUOTAS_REN"]; $i <= $environment["MAXIMO_CUOTAS_REN"]; $i++) {
                    echo "<option value='".$i."'>".$i."</option>";
                  }

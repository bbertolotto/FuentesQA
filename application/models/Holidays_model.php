...
public function add($name,$periodo,$fecha,$dia_habil_anterior,$dia_habil_siguiente){
...
public function edit($name,$periodo,$fecha,$dia_habil_anterior,$dia_habil_siguiente,$id){

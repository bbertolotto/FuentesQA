...
var Client = function() {
    return {
        evaluate: function() {
          ...
          var o = document.getElementById('masked_credit_card');
          if(e.value==""&&o.value==""){
              Alert.showAlert("Ingrese N&#250;mero RUT o N&#250;mero Tarjeta Cr&#233;dito");return(false);}
          else{return(true);}
        },
        prepare: function() {
        ...
        search: function() {
          Client.prepare();e = document.getElementById('masked_rut_client');o = document.getElementById('masked_credit_card');
          var ourl="https://desarrollo.solventa.maximoerp.com/CallWSSolventa/check_client?nroRut="+Rutcl.clear2(e.value)+"&nroTcv="+o.value;

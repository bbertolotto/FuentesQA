...
//          e = document.getElementById("btn-email");e.disabled = true;
  ...
  //        e = document.getElementById("btn-email");e.disabled = false;
        ...
        validate: function(){
          e = document.getElementById("val_offer_amount");
          if(e.value==""){Alert.showAlert("Debe Ingresar Monto Oferta");return(e);}
          e = document.getElementById("val_number_quotas");
          if(e.value==""){Alert.showAlert("Debe Ingresar Número de Cuotas");return(e);}
          e = document.getElementById("val_deferred_quotas");
          if(e.value==""){Alert.showAlert("Debe Ingresar Número de Cuotas");return(e);}
          e = document.getElementById("val_interest_rate");
          if(e.value==""){Alert.showAlert("Debe Ingresar Tasa Interes");return(e);}
          return(true);
        },
        search: function() {
          Client.prepare();e = document.getElementById('masked_rut_client');
          var ourl="https://desarrollo.solventa.maximoerp.com/CallWSSolventa/get_advances?nroRut="+Rutcl.clear2(e.value);
        ...
        init: function() {
            ...
            $('#form-action').validate({
                ...
                rules: {
                    val_offer_amount: {required: true, number: true, range: [250000, 2500000]},
                ...
                messages: {
                    val_offer_amount: {required:'Ingrese Monto Oferta', number: 'Inrgrese solo n&#250;meros', range:'Monto fuera de rango permitido..'},
                    val_number_quotas: {required:'Ingrese N&#250;mero de cuotas', number: 'Inrgrese solo n&#250;meros', range:'Cuotas fuera de rango permitido..'},
                    val_deferred_quotas: {required:'Ingrese N&#250;mero de cuotas a diferir', number: 'Inrgrese solo n&#250;meros',  range:'Cuotas fuera de rango permitido..'},
                    val_interest_rate: {required:'Ingrese Tasa interes',number: 'Inrgrese solo n&#250;meros', range:'Tasa interes fuera de rango permitido..'},
                    val_first_expiration_day: {required:'Ingrese d&#237;a Vencimiento'},
                }
            });

...
var Client = function() {
    return {
        ...
        topay1: function() {
          ...
          var c = document.getElementById('sel_bank');var d = document.getElementById('sel_account_type');
          var e = document.getElementById('val_account_number');
          if(a.checked){a.checked=true;c.disabled=false;d.disabled=false;e.disabled=false;b.checked=false;}
          else{a.checked=false;c.disabled=true;d.disabled=true;e.disabled=true;b.checked=true;}
        },
        topay2: function() {
          var a = document.getElementById('sel_topay1');var b = document.getElementById('sel_topay2');
          var c = document.getElementById('sel_bank');var d = document.getElementById('sel_account_type');
          var e = document.getElementById('val_account_number');
          if(b.checked){b.checked=true;c.disabled=true;d.disabled=true;e.disabled=true;a.checked=false;}
          else{b.checked=false;c.disabled=false;d.disabled=false;e.disabled=false;a.checked=true;}
        },
        evaluate: function() {

...
//End atrapa botones por atención a cliente
    ...
    $('.btn-simulate').on('click', function () {
        ...
        var theForm = document.getElementById("form-action");
...
var Client = function() {
    return {
        ...
        search: function() {
          Client.prepare();e = document.getElementById('masked_rut_client');o = document.getElementById('masked_num_sav');var rutDefault="";
          if(e.value==""){rutDefault="10.526.746-0";}
          else{rutDefault=e.value}
          var ourl="https://desarrollo.solventa.maximoerp.com/CallWSSolventa/check_advances?nroRut="+Teknodata.clear2(rutDefault)+"&nroTcv="+o.value;
        ...
        init: function() {
            ...
            $('#form-action').validate({
                ...
                rules: {
                    ...
                    masked_num_sav: {required: false, number: false}
                },
                messages: {
                    masked_rut_client: {required:'Ingrese n&#250;mero RUT', evalrut:'Ingrese RUT valido!'},
                    masked_num_sav: {required:'Ingrese c&#243;digo SAV', number:'Ingrese c&#243;digo SAV'}
                }
            });
